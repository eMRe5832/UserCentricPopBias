...
load('Dianping\FeatureInfo\Features.mat');
load('Dianping\RatingMatrix\Dianping.mat');
load('Dianping\TopNLists\Random.mat');load('Dianping\TopNLists\ItemAVG.mat');
load('Dianping\TopNLists\MMMF.mat');load('Dianping\TopNLists\WMF.mat');
load('Dianping\TopNLists\HPF.mat');load('Dianping\TopNLists\IBPR.mat');
load('Dianping\TopNLists\WBPR.mat');load('Dianping\TopNLists\SKM.mat');
load('Dianping\TopNLists\NEUMF.mat');load('Dianping\TopNLists\VAECF.mat');

[a,RandomResults]=MetricALL(Dianping, Random);
[a,ItemAVGResults]=MetricALL(Dianping, ItemAVG);
[a,MMMFResults]=MetricALL(Dianping, MMMF);
[a,WMFResults]=MetricALL(Dianping, WMF);
[a,HPFResults]=MetricALL(Dianping, HPF);
[a,IBPRResults]=MetricALL(Dianping, IBPR);
[a,WBPRResults]=MetricALL(Dianping, WBPR);
[a,SKMResults]=MetricALL(Dianping, SKM);
[a,NEUMFResults]=MetricALL(Dianping, NEUMF);
[a,VAECFResults]=MetricALL(Dianping, VAECF);
