...
load('DB\FeatureInfo\Features.mat');
load('DB\RatingMatrix\DB.mat');
load('DB\TopNLists\Random.mat');load('DB\TopNLists\ItemAVG.mat');
load('DB\TopNLists\MMMF.mat');load('DB\TopNLists\WMF.mat');
load('DB\TopNLists\HPF.mat');load('DB\TopNLists\IBPR.mat');
load('DB\TopNLists\WBPR.mat');load('DB\TopNLists\SKM.mat');
load('DB\TopNLists\NEUMF.mat');load('DB\TopNLists\VAECF.mat');

[a,RandomResults]=MetricALL(DB, Random);
[a,ItemAVGResults]=MetricALL(DB, ItemAVG);
[a,MMMFResults]=MetricALL(DB, MMMF);
[a,WMFResults]=MetricALL(DB, WMF);
[a,HPFResults]=MetricALL(DB, HPF);
[a,IBPRResults]=MetricALL(DB, IBPR);
[a,WBPRResults]=MetricALL(DB, WBPR);
[a,SKMResults]=MetricALL(DB, SKM);
[a,NEUMFResults]=MetricALL(DB, NEUMF);
