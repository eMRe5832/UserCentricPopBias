...
load('Yelp\FeatureInfo\Features.mat');
load('Yelp\RatingMatrix\Yelp.mat');
load('Yelp\TopNLists\Random.mat');load('Yelp\TopNLists\ItemAVG.mat');
load('Yelp\TopNLists\MMMF.mat');load('Yelp\TopNLists\WMF.mat');
load('Yelp\TopNLists\HPF.mat');load('Yelp\TopNLists\IBPR.mat');
load('Yelp\TopNLists\WBPR.mat');load('Yelp\TopNLists\SKM.mat');
load('Yelp\TopNLists\NEUMF.mat');load('Yelp\TopNLists\VAECF.mat');

[a,RandomResults]=MetricALL(Yelp, Random);
[a,ItemAVGResults]=MetricALL(Yelp, ItemAVG);
[a,MMMFResults]=MetricALL(Yelp, MMMF);
[a,WMFResults]=MetricALL(Yelp, WMF);
[a,HPFResults]=MetricALL(Yelp, HPF);
[a,IBPRResults]=MetricALL(Yelp, IBPR);
[a,WBPRResults]=MetricALL(Yelp, WBPR);
[a,SKMResults]=MetricALL(Yelp, SKM);
[a,NEUMFResults]=MetricALL(Yelp, NEUMF);
[a,VAECFResults]=MetricALL(Yelp, VAECF);
